...
import java.lang.Math;    					      // Used for Math Operations. Log10() in our case.
...
public class TermFrequency extends Configured implements Tool {
   ...
   public static void main( String[] args) throws  Exception {
      // Call TermFrequency job for the input files and write output.
   ...
   public static class Reduce extends Reducer<Text ,  IntWritable ,  Text ,  DoubleWritable > {
	 ...
	 double wf=0;
		...
		// Caluclate WF(T,d)=1+log10(TF(t,d)).
		wf=1+ Math.log10(sum);
	 // Produce <Key,Value> pairs: <word#####filename, wf>
